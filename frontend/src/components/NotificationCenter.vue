    ...
    <div class="fixed top-0 right-0 z-[9999] pointer-events-none w-full px-4 pt-4">
        <div class="flex justify-end">
            <TransitionGroup name="list" tag="div" class="flex flex-col gap-3">
                <div v-for="notification in notifications" :key="notification.id" :class="getNotificationClasses(notification)" class="pointer-events-auto w-full max-w-sm" @click="handleClose(notification.id)">
