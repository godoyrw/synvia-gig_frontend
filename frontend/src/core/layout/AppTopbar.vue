    ...
    <div class="layout-topbar">
        <div class="layout-topbar-logo-container">
            ...
            <router-link to="/" class="layout-topbar-logo">
                <img :src="isDarkTheme ? SynviaLogoNegativo : SynviaLogoPositivo" alt="SynviaLogo" class="w-35 mt-0" />
            </router-link>
        </div>
        ...
        <div class="layout-topbar-actions">
            <div class="layout-config-menu">
                ...
                <div class="hidden">
                    <!-- Remova essa div para mostrar as opções de personalizção de cor e tema-->
                    <div class="relative">
                        <button
