...
use([CanvasRenderer, BarChart, LineChart, PieChart, HeatmapChart, TreemapChart, GridComponent, TooltipComponent, LegendComponent, TitleComponent, DatasetComponent, VisualMapComponent]);
...
<template>
    <VChart class="base-chart" :option="mergedOption" :theme="theme" :autoresize="autoresize" :style="chartStyle" v-bind="attrs" />
</template>
