<script setup>
import nginxContent from '@/assets/docs/nginx_config.html?raw';
import { computed, ref } from 'vue';

const DOCS = [
    { id: 'nginx', name: 'NGINX / Proxy', icon: '🛰️', content: nginxContent }
];
...
<template>
    <div class="documentation-container">
        <div class="mb-6">
            <h1 class="text-4xl font-bold mb-2 dark:text-surface-0">🖥️ Documentação — Servidores</h1>
            <p class="text-surface-600 dark:text-surface-400">Configuração de proxies e camadas de entrega para o Synvia GIG</p>
        </div>
        ...
        <div class="mt-8 p-4 bg-primary-50 dark:bg-surface-800 rounded-lg border border-primary-200 dark:border-surface-700">
            <p class="text-sm text-surface-600 dark:text-surface-400"><strong>Última atualização:</strong> 06 de Dezembro de 2025</p>
        </div>
    </div>
</template>
