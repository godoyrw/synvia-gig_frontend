...
<template>
    <div class="min-h-screen bg-surface-50 dark:bg-surface-950 py-8 px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto">
            <!-- Header -->
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-surface-900 dark:text-surface-0">Meu Perfil</h1>
                <p class="text-surface-600 dark:text-surface-400 mt-1">Gerencie suas informações pessoais</p>
            </div>
